      ...
      setPlans([
        {
          ...
          yearlyPricePaise: 0,
          popular: false,
          limits: { clients: 3, firmsPerClient: 2, users: 1, storage: '100 MB', credentials: 5 },
        ...
        },
        {
          ...
          popular: false,
          limits: { clients: 15, firmsPerClient: 5, users: 3, storage: '1 GB', credentials: 25 },
        ...
        },
        {
          ...
          popular: true,
          limits: { clients: 50, firmsPerClient: 10, users: 10, storage: '10 GB', credentials: 100 },
