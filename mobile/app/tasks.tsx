        ...
        <View style={styles.form}>
          ...
          <View style={styles.picker}>
            {users.map((user) => (
              <TouchableOpacity
                key={user.id}
                style={[styles.pickerOption, formData.assignedToId === String(user.id) && styles.pickerOptionSelected]}
                onPress={() => setFormData({ ...formData, assignedToId: String(user.id) })}
              >
                <Text style={formData.assignedToId === String(user.id) ? styles.pickerOptionTextSelected : styles.pickerOptionText}>
                  {user.name}
                </Text>
              </TouchableOpacity>
            ))}
