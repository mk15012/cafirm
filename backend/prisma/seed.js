...
async function main() {
  ...
  const activities = [
    { userId: ca.id, actionType: 'CREATE', entityType: 'Client', entityId: client1.id, description: 'Created client ABC Traders Pvt Ltd' },
    { userId: ca.id, actionType: 'CREATE', entityType: 'Firm', entityId: firm1.id, description: 'Created firm ABC Traders Pvt Ltd' },
    { userId: manager.id, actionType: 'CREATE', entityType: 'Task', entityId: createdTasks[0].id, description: 'Created task GST Return Filing' },
    { userId: staff1.id, actionType: 'UPDATE', entityType: 'Task', entityId: createdTasks[0].id, description: 'Updated task status to IN_PROGRESS' },
  ];
